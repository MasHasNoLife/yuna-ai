...
\citet{lin2023awq}, without which a 12B model would not fit alongside its KV
cache on this card. That leaves headroom for the cache and the embedding model;
