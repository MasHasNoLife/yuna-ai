...
39\% of questions that already exceed it. Agentic memory further gives the best
...
$\sim$7--14B, comfortably within a 12\,GB GPU. A hand-verified audit of 200
stored memories finds 199 faithful to their source turn, with no fabrications.
We release the system and benchmark harness.
\end{abstract}
...
context-stuffing where it counts, on temporal reasoning and long conversations, at
